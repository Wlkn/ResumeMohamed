...
const DesktopNav: FC<{navSections: SectionId[]; currentSection: SectionId | null}> = memo(
  ({navSections, currentSection}) => {
    const baseClass =
      '-m-1 p-1 rounded-md  first-letter:uppercase hover:transition-colors hover:duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 sm:hover:text-blue-500 text-neutral-100';
    const activeClass = classNames(baseClass, 'text-blue-500');
    const inactiveClass = classNames(baseClass, 'text-neutral-100');
    return (
      <header className="fixed top-0 z-50 hidden w-full bg-neutral-900/50 p-2.5 backdrop-blur sm:block" id={headerID}>
